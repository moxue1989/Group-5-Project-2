...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="card col-sm-6 offset-sm-1 col-md-6 offset-md-1">
      <div class="header" id="blank"><p class="text-xs-left">Login to your Account</p></div>
        <!--Header-->
            ...
            <div class="card-block loginCard text-xs-center text-md-center">
                ...
                <%--<div class="row col-sm-12 error">--%>
                    <asp:Label CssClass="red-text" ID="lblLoginError" runat="server"></asp:Label>
                <%--</div>--%> 
                <div class="md-form ">
